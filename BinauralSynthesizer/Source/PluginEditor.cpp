    ...
    : AudioProcessorEditor (&p), audioProcessor (p), valueTreeState(vts)
{
    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        setSlider (LFO_freqSlider[i],   juce::Colours::black, juce::Slider::SliderStyle::LinearVertical,                juce::Slider::NoTextBox);
        setSlider (LFO_amtSlider[i],    juce::Colours::black, juce::Slider::SliderStyle::LinearVertical,                juce::Slider::NoTextBox);
    ...
    setSlider (headWidthSlider,       juce::Colours::black, juce::Slider::SliderStyle::LinearHorizontal, juce::Slider::TextBoxBelow);
    setSlider (filterBankResSlider,   juce::Colours::black, juce::Slider::SliderStyle::LinearHorizontal, juce::Slider::TextBoxBelow);
